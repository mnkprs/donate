// landing.jsx — Philotimo public landing (/)
...
const STEPS = [
  ...
  { n: 3, title: 'Route',     short: '1% to Philotimo',   detail: 'A flat 1% platform fee is taken on-chain and visible in the receipt. Nothing else, ever.' },
  ...
  { n: 5, title: 'Publish',   short: 'Public receipt',    detail: 'A shareable receipt is published at philotimo.app/receipt/{tx} — immutable, infinitely verifiable.' },
];
    ...
    <section style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1240, margin: '0 auto' }}>
        <div style={{ maxWidth: 920 }}>
          ...
          {isQuestion ? (
            <h1 style={{
              margin: 0, fontSize: 64, fontWeight: 300,
              letterSpacing: '-1.6px', lineHeight: 1.02,
              color: '#0d253d', textWrap: 'pretty',
            }}>
            ...
            <h1 style={{
              ...
              }}>See exactly where it goes.</span>
            </h1>
          )}
          ...
          <p style={{
            ...
            Philotimo routes everyday card payments through Base L2 to vetted charities — and publishes
            a public, immutable receipt for every donation. No accounts. No crypto knowledge required.
            One percent platform fee, disclosed in plain sight.
          </p>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Mono size={11} color="#64748d">philotimo.app/receipt/0xdc671195…7a78ed</Mono>
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ color: '#64748d', fontSize: 11, letterSpacing: '0.06em', textTransform: 'uppercase' }}>Philotimo fee</div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span><span style={{ color: '#64748d' }}>Philotimo fee</span> $0.50</span>
      ...
      <div style={{ maxWidth: 1240, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 48 }}>
          ...
          <div style={{ fontSize: 13, color: '#64748d', letterSpacing: '-0.1px', textAlign: 'right', maxWidth: 320 }}>
            Hover any step to see what happens. Every step writes to Base — none of it lives on a Philotimo server.
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, fontSize: 13, color: '#273951', letterSpacing: '-0.1px', fontFeatureSettings: '"tnum","ss01"' }}>
            ...
            <span><span style={{ color: '#64748d' }}>Philotimo</span> 1.0%</span>
      ...
      <div style={{ maxWidth: 1240, margin: '0 auto' }}>
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Philotimo (Greek <em style={{ fontStyle: 'italic' }}>φιλότιμο</em>): the sense of duty
        ...
        <div style={{
          ...
          <div style={{ fontFeatureSettings: '"tnum","ss01"' }}>
            © 2026 Philotimo · Donations processed by Endaoment Inc. (EIN 84-3104578) · Tax-deductible to the extent allowed by law
          </div>
...
function PhilotimoLanding({ heroCopy = 'statement', campaignLayout = 'image-top', showLiveStrip = true, showCreamBand = true }) {
  return (
    <div style={{
      background: '#fff',
      color: '#0d253d',
